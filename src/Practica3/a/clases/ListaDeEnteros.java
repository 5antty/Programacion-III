...
public abstract class ListaDeEnteros {
	...
	/**
	 * agrega un elemento al principio de la lista. Si pudo agregarlo devuelve true,
	...
	/**
	 * elimina la primer ocurrencia del elemento elem indicado. Si pudo eliminarlo
	...
	/**
	 * elimina el elemento ubicado en la posicion pos. Si pudo eliminarlo devuelve
